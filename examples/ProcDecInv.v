...
Section Invariants.
  ...
  (*   [repeat eexists; apply xor_1; intuition|]. *)
  ...
  (*         repeat autounfold with MapDefs in H1; simpl in H1; rewrite H1; reflexivity. *)
  (*       } *)
  ...
  (*       repeat eexists. *)
  (*       { repeat autounfold with MapDefs; simpl. *)
  (*         repeat autounfold with MapDefs in H0; simpl in H0; rewrite H0; reflexivity. *)
  (*       } *)
  ...
  (*       repeat eexists. *)
  (*       { repeat autounfold with MapDefs; simpl. *)
  (*         repeat autounfold with MapDefs in H; simpl in H; rewrite H; reflexivity. *)
  (*       } *)
  (*       { repeat autounfold with MapDefs; simpl. *)
  (*         repeat autounfold with MapDefs in H0; simpl in H0; rewrite H0; reflexivity. *)
  (*       } *)
  ...
  (*     pose proof (pfsO_none Hlts); dest; subst. *)
  (*     map_simpl Hstep. *)
