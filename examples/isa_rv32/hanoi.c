unsigned int move_towers(unsigned int, unsigned int /* from */, unsigned int /* to */, unsigned int);
...
unsigned int move_towers(unsigned int num, unsigned int frompeg, unsigned int topeg, unsigned int auxpeg)
{
  if (num == 1)
    {
      return 1;
