...
Infix "<s" := (BinBitBool (Slt _)) (at level 70) : kami_expr_scope.
Notation "x >s y" := (BinBitBool (Slt _) y x) (at level 70, y at next level) : kami_expr_scope.
Notation "x >s= y" := (UniBool NegB (BinBitBool (Slt _) x y)) (at level 70, y at next level) : kami_expr_scope.
Notation "x <s= y" := (UniBool NegB (BinBitBool (Slt _) y x)) (at level 70, y at next level) : kami_expr_scope.
