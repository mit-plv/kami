...
ccomp -O1 -nostartfiles -nodefaultlibs -nostdlib -static -s -T config.ld matmul_init.c
riscv32-unknown-elf-objdump -d a.out > matmul_init.dmp
ccomp -O1 -nostartfiles -nodefaultlibs -nostdlib -static -s -T config.ld matmul_normal1.c
riscv32-unknown-elf-objdump -d a.out > matmul_normal1.dmp
ccomp -O1 -nostartfiles -nodefaultlibs -nostdlib -static -s -T config.ld matmul_normal2.c
riscv32-unknown-elf-objdump -d a.out > matmul_normal2.dmp
ccomp -O1 -nostartfiles -nodefaultlibs -nostdlib -static -s -T config.ld matmul_report.c
