...
int main(int argc, char ** argv, char **env) {
  ...
  while (!Verilated::gotFinish()) {
    ...
    if(top->toHost__024a__024_en == 1)
      std :: cout << "0: " << top->toHost__024a__024_arg << std :: endl;

    if(top->toHost__024aa__024_en == 1)
      std :: cout << "1: " << top->toHost__024aa__024_arg << std :: endl;

    if(top->toHost__024aaa__024_en == 1)
      std :: cout << "2: " << top->toHost__024aaa__024_arg << std :: endl;

    if(top->toHost__024aaaa__024_en == 1)
      std :: cout << "3: " << top->toHost__024aaaa__024_arg << std :: endl;
    */
