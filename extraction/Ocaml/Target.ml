...
let data lgDataBytes =
  Bit
    (mult lgDataBytes (Pervasives.succ (Pervasives.succ
...
let rsToP lgDataBytes lgNumDatas addr3 =
  Struct ({ attrName = ('a'::('d'::('d'::('r'::[])))); attrType =
    ...
    attrType = (line lgDataBytes lgNumDatas) } :: ({ attrName =
    ('i'::('s'::('V'::('o'::('l'::[]))))); attrType =
    Bool } :: []))))
...
let rqFromC lgNumChildren addr3 id =
  Struct ({ attrName = ('c'::('h'::('i'::('l'::('d'::[])))));
    attrType = (child lgNumChildren) } :: ({ attrName =
...
let regFileS name idxBits data2 init =
  makeSinModule (ConsInSinModule ((SMERegister { regGen =
    (fun x -> ExistT ((SyntaxKind (dataArray idxBits data2)),
    (makeConst (dataArray idxBits data2) init))); regName =
    { nameVal =
    (withPrefix name
      ('d'::('a'::('t'::('a'::('A'::('r'::('r'::('a'::('y'::[])))))))))) } }),
    (ConsInSinModule ((SMEMeth { methGen = (ExistT ({ arg =
    (addr idxBits); ret = data2 }, (fun _ a -> SReadReg
    ({ nameVal =
    (withPrefix name
      ('d'::('a'::('t'::('a'::('A'::('r'::('r'::('a'::('y'::[])))))))))) },
    (SyntaxKind (dataArray idxBits data2)), (fun full -> SReturn
    (ReadIndex (idxBits, data2, (Var ((SyntaxKind
    (addr idxBits)), a)), (Var ((SyntaxKind
    (dataArray idxBits data2)), full))))))))); methName =
    { nameVal =
    (withPrefix name ('r'::('e'::('a'::('d'::[]))))) } }),
    (ConsInSinModule ((SMEMeth { methGen = (ExistT ({ arg =
    (writePort idxBits data2); ret = void }, (fun _ w -> SReadReg
    ({ nameVal =
    (withPrefix name
      ('d'::('a'::('t'::('a'::('A'::('r'::('r'::('a'::('y'::[])))))))))) },
    (SyntaxKind (dataArray idxBits data2)), (fun full ->
    SWriteReg ({ nameVal =
    (withPrefix name
      ('d'::('a'::('t'::('a'::('A'::('r'::('r'::('a'::('y'::[])))))))))) },
    (SyntaxKind (Vector (data2, idxBits))), (UpdateVector
    (idxBits, data2, (Var ((SyntaxKind
    (dataArray idxBits data2)), full)), (ReadField (({ attrName =
    ('a'::('d'::('d'::('r'::[])))); attrType =
    (addr idxBits) } :: ({ attrName =
    ('d'::('a'::('t'::('a'::[])))); attrType = data2 } :: [])),
    { bindex = ('a'::('d'::('d'::('r'::[])))); indexb =
    (indexBound_head { attrName = ('a'::('d'::('d'::('r'::[]))));
      attrType = (addr idxBits) }.attrName ({ attrName =
      ('d'::('a'::('t'::('a'::[])))); attrType =
      data2 }.attrName :: [])) }, (Var ((SyntaxKind
    (writePort idxBits data2)), w)))), (ReadField (({ attrName =
    ('a'::('d'::('d'::('r'::[])))); attrType =
    (addr idxBits) } :: ({ attrName =
    ('d'::('a'::('t'::('a'::[])))); attrType = data2 } :: [])),
    ...
    (indexBound_tail ('d'::('a'::('t'::('a'::[])))) { attrName =
      ('a'::('d'::('d'::('r'::[])))); attrType =
      (addr idxBits) }.attrName ({ attrName =
      ('d'::('a'::('t'::('a'::[])))); attrType =
      data2 }.attrName :: [])
      (indexBound_head { attrName =
        ('d'::('a'::('t'::('a'::[])))); attrType =
        data2 }.attrName [])) }, (Var ((SyntaxKind
    (writePort idxBits data2)), w)))))), (SReturn (Const (void,
...
let regFileM name idxBits data2 init =
  makeMetaModule (ConsInMetaModule ((MMERegister (OneReg ((ExistT
    ((SyntaxKind (dataArray idxBits data2)),
    (makeConst (dataArray idxBits data2) init))), { nameVal =
    (withPrefix name
      ('d'::('a'::('t'::('a'::('A'::('r'::('r'::('a'::('y'::[])))))))))) }))),
    ...
    (ReadIndex (idxBits, data2, (Var ((SyntaxKind
    (addr idxBits)), a)), (Var ((SyntaxKind
    (dataArray idxBits data2)), full))))))))), { nameVal =
    (withPrefix name ('r'::('e'::('a'::('d'::[]))))) }))),
    (ConsInMetaModule ((MMEMeth (OneMeth ((ExistT ({ arg =
    (writePort idxBits data2); ret = void }, (fun _ w -> SReadReg
    ({ nameVal =
...
let rsToProcEnq lgDataBytes =
  { attrName =
    (withPrefix
      ('r'::('s'::('T'::('o'::('P'::('r'::('o'::('c'::[]))))))))
      ('e'::('n'::('q'::[])))); attrType = { arg =
    (rsToProc0 lgDataBytes); ret = void } }
...
let rqToPEnq idxBits tagBits id =
  { attrName =
    (withPrefix
      ('r'::('q'::('T'::('o'::('P'::('a'::('r'::('e'::('n'::('t'::[]))))))))))
      ('e'::('n'::('q'::[])))); attrType = { arg =
    (rqToP0 idxBits tagBits id); ret = void } }
...
let rsToPEnq idxBits tagBits lgNumDatas lgDataBytes =
  { attrName =
    (withPrefix
      ('r'::('s'::('T'::('o'::('P'::('a'::('r'::('e'::('n'::('t'::[]))))))))))
      ('e'::('n'::('q'::[])))); attrType = { arg =
    (rsToP0 idxBits tagBits lgNumDatas lgDataBytes); ret =
    void } }
...
let readLine idxBits lgNumDatas lgDataBytes =
  { attrName =
    ...
    (idx idxBits); ret = (line0 lgNumDatas lgDataBytes) } }
...
let writeLine idxBits lgNumDatas lgDataBytes =
  { attrName =
    ...
    (writePort idxBits (line0 lgNumDatas lgDataBytes)); ret =
    void } }
...
let writeTag idxBits tagBits =
  { attrName =
    (withPrefix ('t'::('a'::('g'::[])))
      ('w'::('r'::('i'::('t'::('e'::[])))))); attrType = { arg =
    (writePort idxBits (tag tagBits)); ret = void } }
...
let readCs idxBits =
  { attrName =
    ...
    attrType = { arg = (idx idxBits); ret = msi } }
...
let writeCs idxBits =
  { attrName =
    (withPrefix ('c'::('s'::[]))
      ('w'::('r'::('i'::('t'::('e'::[])))))); attrType = { arg =
    (writePort idxBits msi); ret = void } }

(** val getTagIdx : int -> int -> int -> 'a1 expr -> 'a1 expr **)

let getTagIdx idxBits tagBits lgNumDatas x =
  UniBit ((plus (plus tagBits idxBits) lgNumDatas),
    (plus tagBits idxBits), (TruncLsb ((plus tagBits idxBits),
    lgNumDatas)), x)

(** val getTag : int -> int -> int -> 'a1 expr -> 'a1 expr **)

let getTag idxBits tagBits lgNumDatas x =
  UniBit ((plus tagBits idxBits), tagBits, (TruncLsb (tagBits,
    idxBits)), (getTagIdx idxBits tagBits lgNumDatas x))

(** val getIdx : int -> int -> int -> 'a1 expr -> 'a1 expr **)

let getIdx idxBits tagBits lgNumDatas x =
  UniBit ((plus tagBits idxBits), idxBits, (Trunc (tagBits,
    idxBits)), (getTagIdx idxBits tagBits lgNumDatas x))

(** val getOffset : int -> int -> int -> 'a1 expr -> 'a1 expr **)

let getOffset idxBits tagBits lgNumDatas x =
  UniBit ((plus (plus tagBits idxBits) lgNumDatas), lgNumDatas,
    (Trunc ((plus tagBits idxBits), lgNumDatas)), x)

(** val makeTagIdx :
    int -> int -> 'a1 expr -> 'a1 expr -> 'a1 expr **)

let makeTagIdx idxBits tagBits tag0 idx1 =
  BinBit (tagBits, idxBits, (plus tagBits idxBits), (Concat
    (tagBits, idxBits)), tag0, idx1)
...
let l1Cache idxBits tagBits lgNumDatas lgDataBytes id =
  makeSinModule (ConsInSinModule ((SMERegister { regGen =
    ...
    (rqFromProcFirst idxBits tagBits lgNumDatas lgDataBytes).attrName },
    (rqFromProcFirst idxBits tagBits lgNumDatas lgDataBytes).attrType,
    (Const
    ((rqFromProcFirst idxBits tagBits lgNumDatas lgDataBytes).attrType.arg,
    (getDefaultConst
      (rqFromProcFirst idxBits tagBits lgNumDatas lgDataBytes).attrType.arg))),
    (fun rq -> SLet_ ((SyntaxKind (idx idxBits)),
    (getIdx idxBits tagBits lgNumDatas (ReadField (({ attrName =
      ('a'::('d'::('d'::('r'::[])))); attrType =
      ...
      (indexBound_head { attrName =
        ...
        ('d'::('a'::('t'::('a'::[])))); attrType =
        (data lgDataBytes) }.attrName :: []))) }, (Var
      ((SyntaxKind
      (rqFromProcFirst idxBits tagBits lgNumDatas lgDataBytes).attrType.ret),
      rq))))), (fun idx1 -> SMCall ({ nameVal =
    (readTag idxBits tagBits).attrName },
    (readTag idxBits tagBits).attrType, (Var ((SyntaxKind
    (idx idxBits)), idx1)), (fun tag0 -> SMCall ({ nameVal =
    (readCs idxBits).attrName }, (readCs idxBits).attrType, (Var
    ((SyntaxKind (idx idxBits)), idx1)), (fun cs -> SAssert_
    ((BinBool (And, (BinBool (And, (Eq
    ((readTag idxBits tagBits).attrType.ret, (Var ((SyntaxKind
    (readTag idxBits tagBits).attrType.ret), tag0)),
    (getTag idxBits tagBits lgNumDatas (ReadField (({ attrName =
      ('a'::('d'::('d'::('r'::[])))); attrType =
      (addr0 idxBits tagBits lgNumDatas) } :: ({ attrName =
      ('o'::('p'::[])); attrType = memOp } :: ({ attrName =
      ('d'::('a'::('t'::('a'::[])))); attrType =
      ...
      ((SyntaxKind
      (rqFromProcFirst idxBits tagBits lgNumDatas lgDataBytes).attrType.ret),
      rq))))))), (Eq ((readCs idxBits).attrType.ret, (Var
    ((SyntaxKind (readCs idxBits).attrType.ret), cs)), (Const
    ...
    ('o'::('p'::[])); attrType = memOp } :: ({ attrName =
    ('d'::('a'::('t'::('a'::[])))); attrType =
    (data lgDataBytes) } :: []))), { bindex = ('o'::('p'::[]));
    indexb =
    (indexBound_tail ('o'::('p'::[])) { attrName =
      ('a'::('d'::('d'::('r'::[])))); attrType =
      (addr0 idxBits tagBits lgNumDatas) }.attrName ({ attrName =
      ('o'::('p'::[])); attrType =
      memOp }.attrName :: ({ attrName =
      ('d'::('a'::('t'::('a'::[])))); attrType =
    ...
    (readCs idxBits).attrName }, (readCs idxBits).attrType, (Var
    ((SyntaxKind (idx idxBits)), idx1)), (fun cs -> SAssert_
    ((BinBool (And, (Eq ((readTag idxBits tagBits).attrType.ret,
    (Var ((SyntaxKind (readTag idxBits tagBits).attrType.ret),
    tag0)),
    (getTag idxBits tagBits lgNumDatas (ReadField (({ attrName =
      ('a'::('d'::('d'::('r'::[])))); attrType =
      (addr0 idxBits tagBits lgNumDatas) } :: ({ attrName =
      ...
      ((SyntaxKind
      (rqFromProcFirst idxBits tagBits lgNumDatas lgDataBytes).attrType.ret),
      rq))))))), (BinBool (Or, (BinBool (And, (Eq
    ((readCs idxBits).attrType.ret, (Var ((SyntaxKind
    (readCs idxBits).attrType.ret), cs)), (Const ((Bit
    ...
    (idx idxBits)), idx1)), (fun tag0 -> SMCall ({ nameVal =
    (readCs idxBits).attrName }, (readCs idxBits).attrType, (Var
    ((SyntaxKind (idx idxBits)), idx1)), (fun cs -> SMCall
    ({ nameVal =
    (readLine idxBits lgNumDatas lgDataBytes).attrName },
    (readLine idxBits lgNumDatas lgDataBytes).attrType, (Var
    ((SyntaxKind (idx idxBits)), idx1)), (fun line2 -> SIfElse
    ((UniBool (Neg, (Eq ((readCs idxBits).attrType.ret, (Var
    ((SyntaxKind (readCs idxBits).attrType.ret), cs)), (Const
    ((Bit (Pervasives.succ (Pervasives.succ 0))), (ConstBit
    ((Pervasives.succ (Pervasives.succ 0)),
    (natToWord (Pervasives.succ (Pervasives.succ 0)) inv))))))))),
    ...
    (rsToPEnq idxBits tagBits lgNumDatas lgDataBytes).attrType,
    (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('a'::('d'::('d'::('r'::[])))); attrType = (Bit
        (plus tagBits idxBits)) },
        (makeTagIdx idxBits tagBits (Var ((SyntaxKind
          (readTag idxBits tagBits).attrType.ret), tag0)) (Var
          ((SyntaxKind (idx idxBits)), idx1)))))) :: ((projT1
                                                        (ExistT
                                                        ({ attrName =
                                                        ('t'::('o'::[]));
                                                        attrType =
    ...
    (icons' (ExistT ({ attrName = ('a'::('d'::('d'::('r'::[]))));
      attrType = (Bit (plus tagBits idxBits)) },
      (makeTagIdx idxBits tagBits (Var ((SyntaxKind
        (readTag idxBits tagBits).attrType.ret), tag0)) (Var
    ...
    SMCall ({ nameVal = (writeCs idxBits).attrName },
    (writeCs idxBits).attrType, (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('a'::('d'::('d'::('r'::[])))); attrType =
        (idx idxBits) }, (Var ((SyntaxKind (idx idxBits)),
    ...
    (icons' (ExistT ({ attrName = ('a'::('d'::('d'::('r'::[]))));
      attrType = (idx idxBits) }, (Var ((SyntaxKind
      (idx idxBits)), idx1))))
      ((projT1 (ExistT ({ attrName =
    ...
    (getIdx idxBits tagBits lgNumDatas (ReadField (({ attrName =
      ...
      rq))))), (fun idx1 -> SMCall ({ nameVal =
    (readCs idxBits).attrName }, (readCs idxBits).attrType, (Var
    ((SyntaxKind (idx idxBits)), idx1)), (fun cs -> SLet_
    ...
    0))), (Var ((SyntaxKind (readCs idxBits).attrType.ret), cs)),
    (Var ((SyntaxKind msi), toS)))))), (SMCall ({ nameVal =
    (rqToPEnq idxBits tagBits id).attrName },
    (rqToPEnq idxBits tagBits id).attrType, (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('a'::('d'::('d'::('r'::[])))); attrType =
        (tagIdx idxBits tagBits) },
        (getTagIdx idxBits tagBits lgNumDatas (ReadField
          (({ attrName = ('a'::('d'::('d'::('r'::[]))));
          attrType =
          (addr0 idxBits tagBits lgNumDatas) } :: ({ attrName =
          ('o'::('p'::[])); attrType = memOp } :: ({ attrName =
          ...
          ((SyntaxKind
          (rqFromProc0 idxBits tagBits lgNumDatas lgDataBytes)),
          rq)))))))) :: ((projT1 (ExistT ({ attrName =
                           ('f'::('r'::('o'::('m'::[]))));
                           attrType =
                           (readCs idxBits).attrType.ret }, (Var
                           ((SyntaxKind
                           ...
                           cs))))) :: ((projT1 (ExistT
                                         ...
                                         toS))))) :: ((projT1
                                                        ...
                                                        id }.attrType)))))) :: [])))),
    (icons' (ExistT ({ attrName = ('a'::('d'::('d'::('r'::[]))));
      attrType = (tagIdx idxBits tagBits) },
      (getTagIdx idxBits tagBits lgNumDatas (ReadField
      ...
      ((projT1 (ExistT ({ attrName =
         ('f'::('r'::('o'::('m'::[])))); attrType =
         (readCs idxBits).attrType.ret }, (Var ((SyntaxKind
         (readCs idxBits).attrType.ret), cs))))) :: ((projT1
                                                       (ExistT
                                                       ({ attrName =
                                                       ('t'::('o'::[]));
                                                       attrType =
      ...
      (icons' (ExistT ({ attrName =
        ('f'::('r'::('o'::('m'::[])))); attrType =
        (readCs idxBits).attrType.ret }, (Var ((SyntaxKind
        (readCs idxBits).attrType.ret), cs))))
    ...
    (fromPPop idxBits tagBits lgNumDatas lgDataBytes id).attrType,
    (Const
    ...
    Bool } :: ({ attrName = ('a'::('d'::('d'::('r'::[]))));
    attrType = (tagIdx idxBits tagBits) } :: ({ attrName =
    ...
    (Var ((SyntaxKind
    (fromPPop idxBits tagBits lgNumDatas lgDataBytes id).attrType.ret),
    fromP3)))))), (SLet_ ((SyntaxKind (idx idxBits)),
    (getIdxFromTagIdx idxBits tagBits (ReadField (({ attrName =
      ('i'::('s'::('R'::('q'::[])))); attrType =
      Bool } :: ({ attrName = ('a'::('d'::('d'::('r'::[]))));
      attrType = (tagIdx idxBits tagBits) } :: ({ attrName =
      ('t'::('o'::[])); attrType = msi } :: ({ attrName =
    ...
    (readCs idxBits).attrName }, (readCs idxBits).attrType, (Var
    ((SyntaxKind (idx idxBits)), idx1)), (fun cs -> SMCall
    ({ nameVal = (writeCs idxBits).attrName },
    (writeCs idxBits).attrType, (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('a'::('d'::('d'::('r'::[])))); attrType =
        (idx idxBits) }, (Var ((SyntaxKind (idx idxBits)),
    ...
    (writeTag idxBits tagBits).attrName },
    ...
    (((projT1 (ExistT ({ attrName =
        ...
        idx1))))) :: ((projT1 (ExistT ({ attrName =
                        ('d'::('a'::('t'::('a'::[]))));
                        attrType = (tag tagBits) },
                        (getTagFromTagIdx idxBits tagBits
                          (ReadField (({ attrName =
                          ('i'::('s'::('R'::('q'::[]))));
                          attrType = Bool } :: ({ attrName =
                          ('a'::('d'::('d'::('r'::[]))));
        ...
        (getTagFromTagIdx idxBits tagBits (ReadField
          ...
          (indexBound_tail ('a'::('d'::('d'::('r'::[]))))
            ...
            (indexBound_head { attrName =
              ...
              id }.attrName :: []))))) }, (Var ((SyntaxKind
          (fromPPop idxBits tagBits lgNumDatas lgDataBytes id).attrType.ret),
          fromP3))))))) [] Inil)))), (fun x0 -> SWriteReg
    ({ nameVal =
    ('p'::('r'::('o'::('c'::('R'::('q'::('W'::('a'::('i'::('t'::[])))))))))) },
    (SyntaxKind Bool), (Const (Bool, (ConstBool false))),
    (SIfElse ((Eq ((readCs idxBits).attrType.ret, (Var
    ((SyntaxKind (readCs idxBits).attrType.ret), cs)), (Const
    ((Bit (Pervasives.succ (Pervasives.succ 0))), (ConstBit
    ((Pervasives.succ (Pervasives.succ 0)),
    (natToWord (Pervasives.succ (Pervasives.succ 0)) inv))))))),
    ...
    (writeLine idxBits lgNumDatas lgDataBytes).attrType,
    (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('a'::('d'::('d'::('r'::[])))); attrType =
        (idx idxBits) }, (Var ((SyntaxKind (idx idxBits)),
    ...
    ((SyntaxKind
    (rqFromProc0 idxBits tagBits lgNumDatas lgDataBytes)),
    rq)))))), (SLet_ ((SyntaxKind (idx idxBits)),
    (getIdx idxBits tagBits lgNumDatas (ReadField (({ attrName =
      ('a'::('d'::('d'::('r'::[])))); attrType =
      (addr0 idxBits tagBits lgNumDatas) } :: ({ attrName =
      ('o'::('p'::[])); attrType = memOp } :: ({ attrName =
    ...
    (readCs idxBits).attrName }, (readCs idxBits).attrType, (Var
    ((SyntaxKind (idx idxBits)), idx1)), (fun cs -> SAssert_
    ((UniBool (Neg, (BinBitBool ((Pervasives.succ
    ...
    (readLine idxBits lgNumDatas lgDataBytes).attrName },
    (readLine idxBits lgNumDatas lgDataBytes).attrType, (Var
    ((SyntaxKind (idx idxBits)), idx1)), (fun line2 -> SWriteReg
    ({ nameVal =
    ('p'::('r'::('o'::('c'::('R'::('q'::('V'::('a'::('l'::('i'::('d'::[]))))))))))) },
    (SyntaxKind Bool), (Const (Bool, (ConstBool false))), (SMCall
    ({ nameVal = (rsToProcEnq lgDataBytes).attrName },
    (rsToProcEnq lgDataBytes).attrType, (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('d'::('a'::('t'::('a'::[])))); attrType =
        (data0 lgDataBytes) }, (ReadIndex (lgNumDatas,
        (data0 lgDataBytes),
        (getOffset idxBits tagBits lgNumDatas (ReadField
          (({ attrName = ('a'::('d'::('d'::('r'::[]))));
          attrType =
          (addr0 idxBits tagBits lgNumDatas) } :: ({ attrName =
          ('o'::('p'::[])); attrType = memOp } :: ({ attrName =
    ...
    (icons' (ExistT ({ attrName = ('d'::('a'::('t'::('a'::[]))));
      attrType = (data0 lgDataBytes) }, (ReadIndex (lgNumDatas,
      (data0 lgDataBytes),
      (getOffset idxBits tagBits lgNumDatas (ReadField
        (({ attrName = ('a'::('d'::('d'::('r'::[])))); attrType =
        (addr0 idxBits tagBits lgNumDatas) } :: ({ attrName =
    ...
    (rqFromProcPop idxBits tagBits lgNumDatas lgDataBytes).attrName },
    (rqFromProcPop idxBits tagBits lgNumDatas lgDataBytes).attrType,
    (Const
    ((rqFromProcPop idxBits tagBits lgNumDatas lgDataBytes).attrType.arg,
    (getDefaultConst
      (rqFromProcPop idxBits tagBits lgNumDatas lgDataBytes).attrType.arg))),
    (fun rq' -> SAssert_ ((Eq
    ((rqFromProc0 idxBits tagBits lgNumDatas lgDataBytes), (Var
    ((SyntaxKind
    (rqFromProc0 idxBits tagBits lgNumDatas lgDataBytes)), rq)),
    (Var ((SyntaxKind
    (rqFromProcPop idxBits tagBits lgNumDatas lgDataBytes).attrType.ret),
    rq')))), (SReturn (Const (void,
    ...
    (getIdx idxBits tagBits lgNumDatas (ReadField (({ attrName =
      ...
      rq))))), (fun idx1 -> SMCall ({ nameVal =
    (readCs idxBits).attrName }, (readCs idxBits).attrType, (Var
    ((SyntaxKind (idx idxBits)), idx1)), (fun cs -> SAssert_ ((Eq
    ((readCs idxBits).attrType.ret, (Var ((SyntaxKind
    (readCs idxBits).attrType.ret), cs)), (Const ((Bit
    (Pervasives.succ (Pervasives.succ 0))), (ConstBit
    ((Pervasives.succ (Pervasives.succ 0)),
    ...
    (rsToProcEnq lgDataBytes).attrName },
    (rsToProcEnq lgDataBytes).attrType, (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('d'::('a'::('t'::('a'::[])))); attrType =
        (data lgDataBytes) }, (Const ({ attrName =
        ('d'::('a'::('t'::('a'::[])))); attrType =
        ...
        (getDefaultConst { attrName =
          ...
          (data lgDataBytes) }.attrType)))))) :: []),
    (icons' (ExistT ({ attrName = ('d'::('a'::('t'::('a'::[]))));
      attrType = (data lgDataBytes) }, (Const ({ attrName =
      ('d'::('a'::('t'::('a'::[])))); attrType =
      (data lgDataBytes) }.attrType,
      (getDefaultConst { attrName =
        ('d'::('a'::('t'::('a'::[])))); attrType =
        (data lgDataBytes) }.attrType))))) [] Inil))), (fun x ->
    SMCall ({ nameVal =
    (writeLine idxBits lgNumDatas lgDataBytes).attrName },
    (writeLine idxBits lgNumDatas lgDataBytes).attrType,
    (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ...
        idx1))))) :: ((projT1 (ExistT ({ attrName =
                        ('d'::('a'::('t'::('a'::[]))));
                        attrType = (Vector ((data0 lgDataBytes),
                        lgNumDatas)) }, (UpdateVector
                        (lgNumDatas, (data0 lgDataBytes), (Var
                        ((SyntaxKind
                        (readLine idxBits lgNumDatas lgDataBytes).attrType.ret),
                        line2)), (Var ((SyntaxKind
                        (offset lgNumDatas)), offset0)),
                        (ReadField (({ attrName =
                        ('a'::('d'::('d'::('r'::[]))));
                        attrType =
                        (addr0 idxBits tagBits lgNumDatas) } :: ({ attrName =
    ...
    (icons' (ExistT ({ attrName = ('a'::('d'::('d'::('r'::[]))));
      ...
      ((projT1 (ExistT ({ attrName =
         ...
         ((data0 lgDataBytes), lgNumDatas)) }, (UpdateVector
         (lgNumDatas, (data0 lgDataBytes), (Var ((SyntaxKind
         (readLine idxBits lgNumDatas lgDataBytes).attrType.ret),
         line2)), (Var ((SyntaxKind (offset lgNumDatas)),
    ...
    (readCs idxBits).attrName }, (readCs idxBits).attrType, (Var
    ((SyntaxKind (idx idxBits)), idx1)), (fun cs -> SMCall
    ({ nameVal = (readTag idxBits tagBits).attrName },
    (readTag idxBits tagBits).attrType, (Var ((SyntaxKind
    (idx idxBits)), idx1)), (fun tag0 -> SAssert_ ((BinBool (Or,
    (UniBool (Neg, (BinBitBool ((Pervasives.succ (Pervasives.succ
    0)), (Pervasives.succ (Pervasives.succ 0)), (Lt
    ...
    (Var ((SyntaxKind
    (fromPPop idxBits tagBits lgNumDatas lgDataBytes id).attrType.ret),
    fromP3)))), (Var ((SyntaxKind (readCs idxBits).attrType.ret),
    cs)))))), (UniBool (Neg, (Eq
    ((readTag idxBits tagBits).attrType.ret, (Var ((SyntaxKind
    (readTag idxBits tagBits).attrType.ret), tag0)),
    (getTagFromTagIdx idxBits tagBits (ReadField (({ attrName =
      ('i'::('s'::('R'::('q'::[])))); attrType =
      Bool } :: ({ attrName = ('a'::('d'::('d'::('r'::[]))));
      attrType = (tagIdx idxBits tagBits) } :: ({ attrName =
      ('t'::('o'::[])); attrType = msi } :: ({ attrName =
    ...
    (readLine idxBits lgNumDatas lgDataBytes).attrName },
    (readLine idxBits lgNumDatas lgDataBytes).attrType, (Var
    ((SyntaxKind (idx idxBits)), idx1)), (fun line2 -> SAssert_
    ...
    (fromPPop idxBits tagBits lgNumDatas lgDataBytes id).attrType.ret),
    fromP3)))), (Var ((SyntaxKind (readCs idxBits).attrType.ret),
    cs)))), (Eq ((readTag idxBits tagBits).attrType.ret, (Var
    ...
    ((SyntaxKind
    (rqFromProc0 idxBits tagBits lgNumDatas lgDataBytes)),
    procRq)))), (Eq ((readCs idxBits).attrType.ret, (Var
    ((SyntaxKind (readCs idxBits).attrType.ret), cs)), (Const
    ((Bit (Pervasives.succ (Pervasives.succ 0))), (ConstBit
    ((Pervasives.succ (Pervasives.succ 0)),
    (natToWord (Pervasives.succ (Pervasives.succ 0)) mod0))))))))),
    ...
    (fun x -> SMCall ({ nameVal = (writeCs idxBits).attrName },
    (writeCs idxBits).attrType, (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('a'::('d'::('d'::('r'::[])))); attrType =
        (idx idxBits) }, (Var ((SyntaxKind (idx idxBits)),
...
let rqFromCEnq idxBits lgNumChildren id =
  { attrName =
    (withPrefix
      ...
      ('e'::('n'::('q'::[])))); attrType = { arg =
    (rqFromC0 idxBits lgNumChildren id); ret = void } }
...
let rsFromCEnq idxBits lgNumDatas lgDataBytes lgNumChildren =
  { attrName =
    (withPrefix
      ...
      ('e'::('n'::('q'::[])))); attrType = { arg =
    (rsFromC0 idxBits lgNumDatas lgDataBytes lgNumChildren);
    ret = void } }
...
let toCPop idxBits lgNumDatas lgDataBytes lgNumChildren id =
  { attrName =
    (withPrefix
      ('t'::('o'::('C'::('h'::('i'::('l'::('d'::[])))))))
      ('d'::('e'::('q'::[])))); attrType = { arg = void; ret =
    (toC0 idxBits lgNumDatas lgDataBytes lgNumChildren id) } }
...
let fromPEnq idxBits lgNumDatas lgDataBytes id =
  { attrName =
    (withPrefix
      ('f'::('r'::('o'::('m'::('P'::('a'::('r'::('e'::('n'::('t'::[]))))))))))
      ('e'::('n'::('q'::[])))); attrType = { arg =
    (fromP1 idxBits lgNumDatas lgDataBytes id); ret = void } }
...
let childParent idxBits lgNumDatas lgDataBytes lgNumChildren id =
  makeMetaModule (ConsInMetaModule ((MMERule (RepRule
    ((Obj.magic string_of_nat), (Bit lgNumChildren),
    (Obj.magic (natToWordConst lgNumChildren)), (fun _ -> GIndex
    (fun i -> GMCall ({ isRep = true; nameRec0 = { nameVal =
    (rqToPPop idxBits id).attrName } },
    (rqToPPop idxBits id).attrType, (Const
    ((rqToPPop idxBits id).attrType.arg,
    (getDefaultConst (rqToPPop idxBits id).attrType.arg))),
    (fun rq -> GMCall ({ isRep = false; nameRec0 = { nameVal =
    (rqFromCEnq idxBits lgNumChildren id).attrName } },
    (rqFromCEnq idxBits lgNumChildren id).attrType, (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
        (child lgNumChildren) }, (Var ((SyntaxKind { attrName =
        ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
        (child lgNumChildren) }.attrType), i))))) :: ((projT1
                                                        (ExistT
                                                        ({ attrName =
                                                        ('r'::('q'::[]));
                                                        attrType =
    ...
    (icons' (ExistT ({ attrName =
      ...
      (child lgNumChildren) }, (Var ((SyntaxKind { attrName =
      ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
      (child lgNumChildren) }.attrType), i))))
      ...
      (icons' (ExistT ({ attrName = ('r'::('q'::[])); attrType =
        (rqToPPop idxBits id).attrType.ret }, (Var ((SyntaxKind
        (rqToPPop idxBits id).attrType.ret), rq)))) [] Inil)))),
    (fun x -> GReturn (Const (void,
    (getDefaultConst void))))))))), { nameVal =
    ('r'::('q'::('F'::('r'::('o'::('m'::('C'::('T'::('o'::('P'::[])))))))))) },
    (Obj.magic
      (getNatListToN
        (wordToNat lgNumChildren (wones lgNumChildren))))))),
    (ConsInMetaModule ((MMERule (RepRule
    ((Obj.magic string_of_nat), (Bit lgNumChildren),
    (Obj.magic (natToWordConst lgNumChildren)), (fun _ -> GIndex
    (fun i -> GMCall ({ isRep = true; nameRec0 = { nameVal =
    (rsToPPop idxBits lgNumDatas lgDataBytes).attrName } },
    ...
    (rsFromCEnq idxBits lgNumDatas lgDataBytes lgNumChildren).attrType,
    (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
        (child lgNumChildren) }, (Var ((SyntaxKind { attrName =
    ...
    (icons' (ExistT ({ attrName =
      ...
      ((projT1 (ExistT ({ attrName = ('r'::('s'::[])); attrType =
         (rsToPPop idxBits lgNumDatas lgDataBytes).attrType.ret },
         (Var ((SyntaxKind
         (rsToPPop idxBits lgNumDatas lgDataBytes).attrType.ret),
         rs))))) :: [])
    ...
    (toCPop idxBits lgNumDatas lgDataBytes lgNumChildren id).attrName } },
    (toCPop idxBits lgNumDatas lgDataBytes lgNumChildren id).attrType,
    (Const
    ...
    ((getAttrType ({ attrName =
       ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
       (child lgNumChildren) } :: ({ attrName =
       ('m'::('s'::('g'::[]))); attrType =
       (fromP lgDataBytes lgNumDatas (addr1 idxBits) id) } :: []))
       { bindex = ('c'::('h'::('i'::('l'::('d'::[]))))); indexb =
       (indexBound_head { attrName =
         ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
         (child lgNumChildren) }.attrName ({ attrName =
         ('m'::('s'::('g'::[]))); attrType =
    ...
    (indexBound_head { attrName =
      ...
      (fromP lgDataBytes lgNumDatas (addr1 idxBits) id) }.attrName :: [])) },
    (Var ((SyntaxKind
    (toCPop idxBits lgNumDatas lgDataBytes lgNumChildren id).attrType.ret),
    msg)))))), (GMCall ({ isRep = true; nameRec0 = { nameVal =
    (fromPEnq idxBits lgNumDatas lgDataBytes id).attrName } },
    (fromPEnq idxBits lgNumDatas lgDataBytes id).attrType,
    (ReadField (({ attrName =
    ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
    (child lgNumChildren) } :: ({ attrName =
    ('m'::('s'::('g'::[]))); attrType =
...
let toCEnq idxBits lgNumDatas lgDataBytes lgNumChildren id =
  { attrName =
    (withPrefix
      ('t'::('o'::('C'::('h'::('i'::('l'::('d'::[])))))))
      ('e'::('n'::('q'::[])))); attrType = { arg =
    (toC1 idxBits lgNumDatas lgDataBytes lgNumChildren id); ret =
    void } }
...
let readLine0 idxBits lgNumDatas lgDataBytes =
  { attrName =
    (withPrefix ('m'::('l'::('i'::('n'::('e'::[])))))
      ('r'::('e'::('a'::('d'::[]))))); attrType = { arg =
    (idx0 idxBits); ret = (line1 lgNumDatas lgDataBytes) } }
...
let writeLine0 idxBits lgNumDatas lgDataBytes =
  { attrName =
    (withPrefix ('m'::('l'::('i'::('n'::('e'::[])))))
      ('w'::('r'::('i'::('t'::('e'::[])))))); attrType = { arg =
    (writePort idxBits (line1 lgNumDatas lgDataBytes)); ret =
    void } }
...
let readDir idxBits lgNumChildren =
  { attrName =
    (withPrefix ('m'::('c'::('s'::[])))
      ('r'::('e'::('a'::('d'::[]))))); attrType = { arg =
    (idx0 idxBits); ret = (dir lgNumChildren) } }
...
let writeDir idxBits lgNumChildren =
  { attrName =
    (withPrefix ('m'::('c'::('s'::[])))
      ('w'::('r'::('i'::('t'::('e'::[])))))); attrType = { arg =
    (writePort idxBits (dir lgNumChildren)); ret = void } }
...
let othersCompat lgNumChildren c x dir0 =
  foldInc Bool lgNumChildren (fun idx1 old -> ITE ((SyntaxKind
    Bool), (UniBool (Neg, (Eq ((child0 lgNumChildren), c,
    idx1)))), (BinBool (And,
    (isCompat x (ReadIndex (lgNumChildren, msi, idx1, dir0))),
...
let findIncompat lgNumChildren c x dir0 dirw0 =
  foldInc (maybe (child0 lgNumChildren)) lgNumChildren
    ...
    Bool } :: ({ attrName =
    ('v'::('a'::('l'::('u'::('e'::[]))))); attrType =
    (child0 lgNumChildren) } :: [])), { bindex =
    ('v'::('a'::('l'::('i'::('d'::[]))))); indexb =
    (indexBound_head { attrName =
      ('v'::('a'::('l'::('i'::('d'::[]))))); attrType =
      Bool }.attrName ({ attrName =
      ('v'::('a'::('l'::('u'::('e'::[]))))); attrType =
      (child0 lgNumChildren) }.attrName :: [])) }, old)))),
    (UniBool (Neg, (Eq ((child0 lgNumChildren), c, idx1)))))),
    (UniBool (Neg,
    (isCompat x (ReadIndex (lgNumChildren, msi, idx1, dir0))))))),
    (UniBool (Neg, (ReadIndex (lgNumChildren, Bool, idx1,
    dirw0)))))), (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('v'::('a'::('l'::('i'::('d'::[]))))); attrType = Bool },
        (Const (Bool, (ConstBool true)))))) :: ((projT1 (ExistT
...
let dirwInit lgNumChildren =
  ConstVector (Bool, lgNumChildren,
    (replicate (ConstBool false) lgNumChildren))
...
let memDir idxBits lgNumDatas lgDataBytes lgNumChildren id =
  makeMetaModule (ConsInMetaModule ((MMERegister (OneReg ((ExistT
    ...
    (dirw lgNumChildren)),
    (makeConst (dirw lgNumChildren) (dirwInit lgNumChildren)))),
    { nameVal =
    ('c'::('R'::('q'::('D'::('i'::('r'::('w'::[]))))))) }))),
    ...
    (getAttrType ({ attrName =
      ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
      (child lgNumChildren) } :: ({ attrName = ('r'::('q'::[]));
      attrType = (rqToP (addr2 idxBits) id) } :: [])) { bindex =
      ('c'::('h'::('i'::('l'::('d'::[]))))); indexb =
      (indexBound_head { attrName =
        ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
        (child lgNumChildren) }.attrName ({ attrName =
    ...
    (indexBound_head { attrName =
      ...
      (child lgNumChildren) }.attrName ({ attrName =
      ('r'::('q'::[])); attrType =
      (rqToP (addr2 idxBits) id) }.attrName :: [])) }, (Var
    ((SyntaxKind
    (rqFromCFirst idxBits lgNumChildren id).attrType.ret),
    rqChild)))), (fun c -> SLet_ ((SyntaxKind
    (rqToP2 idxBits id)), (ReadField (({ attrName =
    ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
    (child lgNumChildren) } :: ({ attrName = ('r'::('q'::[]));
    attrType = (rqToP (addr2 idxBits) id) } :: [])), { bindex =
    ('r'::('q'::[])); indexb =
    ...
    ((SyntaxKind
    (rqFromCFirst idxBits lgNumChildren id).attrType.ret),
    rqChild)))), (fun rq -> SLet_ ((SyntaxKind (idx0 idxBits)),
    (getIdx0 idxBits (ReadField (({ attrName =
      ('a'::('d'::('d'::('r'::[])))); attrType =
      ...
      (indexBound_head { attrName =
        ('a'::('d'::('d'::('r'::[])))); attrType =
        (addr2 idxBits) }.attrName ({ attrName =
        ('f'::('r'::('o'::('m'::[])))); attrType =
    ...
    (readDir idxBits lgNumChildren).attrName },
    (readDir idxBits lgNumChildren).attrType, (Var ((SyntaxKind
    (idx0 idxBits)), idx1)), (fun dir0 -> SAssert_ ((UniBool
    ...
    (rqToP2 idxBits id)), rq)))), (ReadIndex (lgNumChildren, msi,
    (Var ((SyntaxKind
    (getAttrType ({ attrName =
      ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
      (child lgNumChildren) } :: ({ attrName = ('r'::('q'::[]));
    ...
    (Var ((SyntaxKind
    (readDir idxBits lgNumChildren).attrType.ret), dir0)))))))),
    (SWriteReg ({ nameVal =
    ('c'::('R'::('q'::('V'::('a'::('l'::('i'::('d'::[])))))))) },
    (SyntaxKind Bool), (Const (Bool, (ConstBool true))), (SLet_
    ((SyntaxKind (dirw lgNumChildren)), (BuildVector (Bool,
    lgNumChildren,
    (replicate (Const (Bool, (ConstBool false))) lgNumChildren))),
    (fun dirw0 -> SWriteReg ({ nameVal =
    ('c'::('R'::('q'::('D'::('i'::('r'::('w'::[]))))))) },
    (SyntaxKind (dirw lgNumChildren)), (Var ((SyntaxKind
    (dirw lgNumChildren)), dirw0)), (SReturn (Const (void,
    (getDefaultConst void)))))))))))))))))))))))))), { nameVal =
    ...
    ('c'::('R'::('q'::('D'::('i'::('r'::('w'::[]))))))) },
    (SyntaxKind (dirw lgNumChildren)), (fun dirw0 -> SLet_
    ((SyntaxKind (maybe (child0 lgNumChildren))),
    (findIncompat lgNumChildren (Var ((SyntaxKind
      (getAttrType ({ attrName =
        ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
        (child lgNumChildren) } :: ({ attrName =
        ('r'::('q'::[])); attrType =
        (rqToP (addr2 idxBits) id) } :: [])) { bindex =
        ('c'::('h'::('i'::('l'::('d'::[]))))); indexb =
        (indexBound_head { attrName =
          ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
          (child lgNumChildren) }.attrName ({ attrName =
      ...
      (indexBound_tail ('t'::('o'::[])) { attrName =
        ...
        (indexBound_tail ('t'::('o'::[])) { attrName =
          ...
          (indexBound_head { attrName = ('t'::('o'::[]));
            attrType = msi }.attrName ({ attrName =
            ('i'::('d'::[])); attrType = id }.attrName :: [])))) },
      (Var ((SyntaxKind (rqToP2 idxBits id)), rq)))) (Var
      ((SyntaxKind (readDir idxBits lgNumChildren).attrType.ret),
      dir0)) (Var ((SyntaxKind (dirw lgNumChildren)), dirw0))),
    ...
    (indexBound_head { attrName =
      ...
      Bool }.attrName ({ attrName =
      ('v'::('a'::('l'::('u'::('e'::[]))))); attrType =
      (child0 lgNumChildren) }.attrName :: [])) }, (Var
    ((SyntaxKind (maybe (child0 lgNumChildren))), i)))), (SLet_
    ((SyntaxKind (fromP2 idxBits lgNumDatas lgDataBytes id)),
    (BuildStruct
    (((projT1 (ExistT ({ attrName =
    ...
    (projT1 (ExistT ({ attrName = ('t'::('o'::[])); attrType =
      ...
      (toCompat (ReadField (({ attrName =
        ...
        (Var ((SyntaxKind (rqToP2 idxBits id)), rq)))))))) :: (
    (projT1 (ExistT ({ attrName = ('l'::('i'::('n'::('e'::[]))));
      attrType = (line lgDataBytes lgNumDatas) }, (Const
    ...
    (icons' (ExistT ({ attrName = ('i'::('s'::('R'::('q'::[]))));
      ...
      (icons' (ExistT ({ attrName =
        ...
        (icons' (ExistT ({ attrName = ('t'::('o'::[]));
          ...
          ((projT1 (ExistT ({ attrName =
             ('l'::('i'::('n'::('e'::[])))); attrType =
             (line lgDataBytes lgNumDatas) }, (Const
             ({ attrName = ('l'::('i'::('n'::('e'::[]))));
          ...
          (icons' (ExistT ({ attrName =
            ('l'::('i'::('n'::('e'::[])))); attrType =
            (line lgDataBytes lgNumDatas) }, (Const ({ attrName =
            ('l'::('i'::('n'::('e'::[])))); attrType =
            (line lgDataBytes lgNumDatas) }.attrType,
            (getDefaultConst { attrName =
              ('l'::('i'::('n'::('e'::[])))); attrType =
    ...
    (toCEnq idxBits lgNumDatas lgDataBytes lgNumChildren id).attrType,
    (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
        (getAttrType ({ attrName =
        ...
        c))))) :: ((projT1 (ExistT ({ attrName =
                     ('m'::('s'::('g'::[]))); attrType =
                     (fromP2 idxBits lgNumDatas lgDataBytes id) },
                     (Var ((SyntaxKind
                     (fromP2 idxBits lgNumDatas lgDataBytes id)),
                     rq'))))) :: [])),
    (icons' (ExistT ({ attrName =
      ...
      ((projT1 (ExistT ({ attrName = ('m'::('s'::('g'::[])));
         attrType = (fromP2 idxBits lgNumDatas lgDataBytes id) },
         (Var ((SyntaxKind
    ...
    lgNumChildren))), (UpdateVector (lgNumChildren, Bool, (Var
    ((SyntaxKind (dirw lgNumChildren)), dirw0)), (Var
    ((SyntaxKind
    (getAttrType ({ attrName =
      ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
      (child lgNumChildren) } :: ({ attrName = ('r'::('q'::[]));
    ...
    ({ nameVal =
    ('c'::('R'::('q'::('D'::('i'::('r'::('w'::[]))))))) },
    (SyntaxKind (Vector (Bool, lgNumChildren))), (Var
    ((SyntaxKind (Vector (Bool, lgNumChildren))), dirw')),
    (SReturn (Const (void,
    (getDefaultConst void)))))))))))))))))))))))))))))),
    { nameVal = ('d'::('w'::('n'::('R'::('q'::[]))))) }))),
    (ConsInMetaModule ((MMERule (OneRule ((fun _ -> SMCall
    ({ nameVal =
    (rsFromCPop idxBits lgNumDatas lgDataBytes lgNumChildren).attrName },
    (rsFromCPop idxBits lgNumDatas lgDataBytes lgNumChildren).attrType,
    (Const
    ...
    (getAttrType ({ attrName =
      ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
      (child lgNumChildren) } :: ({ attrName = ('r'::('s'::[]));
      attrType =
      (rsToP lgDataBytes lgNumDatas (addr2 idxBits)) } :: []))
      { bindex = ('c'::('h'::('i'::('l'::('d'::[]))))); indexb =
      (indexBound_head { attrName =
    ...
    (indexBound_head { attrName =
      ...
      (rsToP lgDataBytes lgNumDatas (addr2 idxBits)) }.attrName :: [])) },
    (Var ((SyntaxKind
    (rsFromCPop idxBits lgNumDatas lgDataBytes lgNumChildren).attrType.ret),
    rsChild)))), (fun c -> SLet_ ((SyntaxKind
    (rsToP2 idxBits lgNumDatas lgDataBytes)), (ReadField
    (({ attrName = ('c'::('h'::('i'::('l'::('d'::[])))));
    attrType = (child lgNumChildren) } :: ({ attrName =
    ('r'::('s'::[])); attrType =
    (rsToP lgDataBytes lgNumDatas (addr2 idxBits)) } :: [])),
    ...
    (indexBound_tail ('r'::('s'::[])) { attrName =
      ...
      (indexBound_head { attrName = ('r'::('s'::[])); attrType =
        ...
        [])) }, (Var ((SyntaxKind
    (rsFromCPop idxBits lgNumDatas lgDataBytes lgNumChildren).attrType.ret),
    rsChild)))), (fun rs -> SLet_ ((SyntaxKind (idx0 idxBits)),
    (getIdx0 idxBits (ReadField (({ attrName =
      ('a'::('d'::('d'::('r'::[])))); attrType =
      (addr2 idxBits) } :: ({ attrName = ('t'::('o'::[]));
      attrType = msi } :: ({ attrName =
      ('l'::('i'::('n'::('e'::[])))); attrType =
      (line lgDataBytes lgNumDatas) } :: ({ attrName =
      ('i'::('s'::('V'::('o'::('l'::[]))))); attrType =
      ...
      (rsToP2 idxBits lgNumDatas lgDataBytes)), rs))))),
    (fun idx1 -> SMCall ({ nameVal =
    (readDir idxBits lgNumChildren).attrName },
    (readDir idxBits lgNumChildren).attrType, (Var ((SyntaxKind
    (idx0 idxBits)), idx1)), (fun dir0 -> SLet_ ((SyntaxKind
    (Vector (msi, lgNumChildren))), (UpdateVector (lgNumChildren,
    msi, (Var ((SyntaxKind
    (readDir idxBits lgNumChildren).attrType.ret), dir0)), (Var
    ((SyntaxKind
    (getAttrType ({ attrName =
      ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
      (child lgNumChildren) } :: ({ attrName = ('r'::('s'::[]));
    ...
    (indexBound_tail ('t'::('o'::[])) { attrName =
      ('a'::('d'::('d'::('r'::[])))); attrType =
      (addr2 idxBits) }.attrName ({ attrName = ('t'::('o'::[]));
      attrType = msi }.attrName :: ({ attrName =
      ('l'::('i'::('n'::('e'::[])))); attrType =
      (line lgDataBytes lgNumDatas) }.attrName :: ({ attrName =
      ('i'::('s'::('V'::('o'::('l'::[]))))); attrType =
    ...
    (writeDir idxBits lgNumChildren).attrName },
    (writeDir idxBits lgNumChildren).attrType, (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('a'::('d'::('d'::('r'::[])))); attrType =
        (idx0 idxBits) }, (Var ((SyntaxKind (idx0 idxBits)),
        idx1))))) :: ((projT1 (ExistT ({ attrName =
                        ('d'::('a'::('t'::('a'::[]))));
                        attrType = (Vector (msi,
    ...
    (icons' (ExistT ({ attrName = ('a'::('d'::('d'::('r'::[]))));
      attrType = (idx0 idxBits) }, (Var ((SyntaxKind
      (idx0 idxBits)), idx1))))
      ((projT1 (ExistT ({ attrName =
         ('d'::('a'::('t'::('a'::[])))); attrType = (Vector (msi,
         lgNumChildren)) }, (Var ((SyntaxKind (Vector (msi,
         lgNumChildren))), dir'))))) :: [])
      (icons' (ExistT ({ attrName =
        ('d'::('a'::('t'::('a'::[])))); attrType = (Vector (msi,
        lgNumChildren)) }, (Var ((SyntaxKind (Vector (msi,
        lgNumChildren))), dir')))) [] Inil)))), (fun x ->
    SReadReg ({ nameVal =
    ('c'::('R'::('q'::('D'::('i'::('r'::('w'::[]))))))) },
    (SyntaxKind (Vector (Bool, lgNumChildren))), (fun dirw0 ->
    SLet_ ((SyntaxKind (Vector (Bool, lgNumChildren))),
    (UpdateVector (lgNumChildren, Bool, (Var ((SyntaxKind (Vector
    (Bool, lgNumChildren))), dirw0)), (Var ((SyntaxKind
    (getAttrType ({ attrName =
      ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
      (child lgNumChildren) } :: ({ attrName = ('r'::('s'::[]));
      attrType =
    ...
    (SyntaxKind (Vector (Bool, lgNumChildren))), (Var
    ((SyntaxKind (Vector (Bool, lgNumChildren))), dirw')),
    (SIfElse ((Eq (msi, (ReadIndex (lgNumChildren, msi, (Var
    ((SyntaxKind
    (getAttrType ({ attrName =
      ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
      (child lgNumChildren) } :: ({ attrName = ('r'::('s'::[]));
    ...
    (writeLine0 idxBits lgNumDatas lgDataBytes).attrType,
    (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('a'::('d'::('d'::('r'::[])))); attrType =
        (idx0 idxBits) }, (Var ((SyntaxKind (idx0 idxBits)),
    ...
    (indexBound_head { attrName =
      ...
      (rqToP (addr2 idxBits) id) }.attrName :: [])) }, (Var
    ((SyntaxKind
    (rqFromCPop idxBits lgNumChildren id).attrType.ret),
    rqChild)))), (fun c -> SLet_ ((SyntaxKind
    (rqToP2 idxBits id)), (ReadField (({ attrName =
    ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
    (child lgNumChildren) } :: ({ attrName = ('r'::('q'::[]));
    ...
    ((othersCompat lgNumChildren (Var ((SyntaxKind
       ...
       (readDir idxBits lgNumChildren).attrType.ret), dir0))),
    (SMCall ({ nameVal =
    (readLine0 idxBits lgNumDatas lgDataBytes).attrName },
    (readLine0 idxBits lgNumDatas lgDataBytes).attrType, (Var
    ((SyntaxKind (idx0 idxBits)), idx1)), (fun line2 -> SLet_
    ((SyntaxKind (fromP2 idxBits lgNumDatas lgDataBytes id)),
    (BuildStruct
    (((projT1 (ExistT ({ attrName =
        ('i'::('s'::('R'::('q'::[])))); attrType = Bool }, (Const
    ...
    (projT1 (ExistT ({ attrName = ('l'::('i'::('n'::('e'::[]))));
      attrType =
      (readLine0 idxBits lgNumDatas lgDataBytes).attrType.ret },
      (Var ((SyntaxKind
      (readLine0 idxBits lgNumDatas lgDataBytes).attrType.ret),
      line2))))) :: ((projT1 (ExistT ({ attrName =
                       ('i'::('d'::[])); attrType =
    ...
    lgNumChildren))), (UpdateVector (lgNumChildren, msi, (Var
    ((SyntaxKind (readDir idxBits lgNumChildren).attrType.ret),
    dir0)), (Var ((SyntaxKind
    (getAttrType ({ attrName =
      ('c'::('h'::('i'::('l'::('d'::[]))))); attrType =
...
let l1Cache0 idxBits tagBits lgNumDatas lgDataBytes id lgNumChildren =
  getMetaFromSinNat lgNumChildren
    (l1Cache idxBits tagBits lgNumDatas lgDataBytes id)

(** val l1cs : int -> int -> metaModule **)

let l1cs idxBits lgNumChildren =
  getMetaFromSinNat lgNumChildren
    (regFileS ('c'::('s'::[])) idxBits msi
      (getDefaultConst (dataArray idxBits msi)))
...
let l1line idxBits lgNumDatas lgDataBytes lgNumChildren =
  getMetaFromSinNat lgNumChildren
    (regFileS ('l'::('i'::('n'::('e'::[])))) idxBits
      (line0 lgNumDatas lgDataBytes)
      (getDefaultConst
        (dataArray idxBits (line0 lgNumDatas lgDataBytes))))
...
let fifoRsToP idxBits tagBits lgNumDatas lgDataBytes fifoSize lgNumChildren =
  getMetaFromSinNat lgNumChildren
    (simpleFifoS
      ('r'::('s'::('T'::('o'::('P'::('a'::('r'::('e'::('n'::('t'::[]))))))))))
      (rsz fifoSize)
      (rsToP2 (mIdxBits idxBits tagBits) lgNumDatas lgDataBytes))
...
let fifoFromP idxBits tagBits lgNumDatas lgDataBytes id fifoSize lgNumChildren =
  getMetaFromSinNat lgNumChildren
    (simpleFifoS
      ('f'::('r'::('o'::('m'::('P'::('a'::('r'::('e'::('n'::('t'::[]))))))))))
      (rsz fifoSize)
      (fromP2 (mIdxBits idxBits tagBits) lgNumDatas lgDataBytes
        id))
...
let childParent0 idxBits tagBits lgNumDatas lgDataBytes id lgNumChildren =
  childParent (mIdxBits idxBits tagBits) lgNumDatas lgDataBytes
    lgNumChildren id
...
let fifoRqFromC idxBits tagBits id fifoSize lgNumChildren =
  fifoM
    ('r'::('q'::('F'::('r'::('o'::('m'::('C'::('h'::('i'::('l'::('d'::[])))))))))))
    (rsz fifoSize)
    (rqFromC1 (mIdxBits idxBits tagBits) lgNumChildren id)
...
let fifoRsFromC idxBits tagBits lgNumDatas lgDataBytes fifoSize lgNumChildren =
  simpleFifoM
    ('r'::('s'::('F'::('r'::('o'::('m'::('C'::('h'::('i'::('l'::('d'::[])))))))))))
    (rsz fifoSize)
    (rsFromC1 (mIdxBits idxBits tagBits) lgNumDatas lgDataBytes
      lgNumChildren)
...
let fifoToC idxBits tagBits lgNumDatas lgDataBytes id fifoSize lgNumChildren =
  simpleFifoM ('t'::('o'::('C'::('h'::('i'::('l'::('d'::[])))))))
    (rsz fifoSize)
    (toC1 (mIdxBits idxBits tagBits) lgNumDatas lgDataBytes
      lgNumChildren id)
...
let memDir0 idxBits tagBits lgNumDatas lgDataBytes id lgNumChildren =
  memDir (mIdxBits idxBits tagBits) lgNumDatas lgDataBytes
    lgNumChildren id
...
let mline idxBits tagBits lgNumDatas lgDataBytes =
  regFileM ('m'::('l'::('i'::('n'::('e'::[])))))
    (mIdxBits idxBits tagBits) (line1 lgNumDatas lgDataBytes)
    (getDefaultConst
      (dataArray (mIdxBits idxBits tagBits)
        (line1 lgNumDatas lgDataBytes)))

(** val mdir : int -> int -> int -> metaModule **)

let mdir idxBits tagBits lgNumChildren =
  regFileM ('m'::('c'::('s'::[]))) (mIdxBits idxBits tagBits)
    (dir lgNumChildren)
    (getDefaultConst
      (dataArray (mIdxBits idxBits tagBits) (dir lgNumChildren)))
...
let l1Con =
  ConcatMod
    ((modFromMeta
       (l1Cache0 (Pervasives.succ (Pervasives.succ 0))
         (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ
         (Pervasives.succ 0)) (Pervasives.succ (Pervasives.succ
         0)) (Bit (Pervasives.succ 0)) (Pervasives.succ 0))),
    (ConcatMod ((ConcatMod
    ((modFromMeta
       (l1cs (Pervasives.succ (Pervasives.succ 0))
         (Pervasives.succ 0))), (ConcatMod
    ((modFromMeta
       (l1tag (Pervasives.succ (Pervasives.succ 0))
         (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ
         0))),
    (modFromMeta
      (l1line (Pervasives.succ (Pervasives.succ 0))
        (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ
        (Pervasives.succ 0)) (Pervasives.succ 0))))))),
    (ConcatMod
    ((modFromMeta
       (fifoRqToP (Pervasives.succ (Pervasives.succ 0))
         (Pervasives.succ (Pervasives.succ 0)) (Bit
         (Pervasives.succ 0)) (Pervasives.succ (Pervasives.succ
         0)) (Pervasives.succ 0))), (ConcatMod
    ((modFromMeta
       (fifoRsToP (Pervasives.succ (Pervasives.succ 0))
         (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ
         (Pervasives.succ 0)) (Pervasives.succ (Pervasives.succ
         0)) (Pervasives.succ (Pervasives.succ 0))
         (Pervasives.succ 0))),
    (modFromMeta
      (fifoFromP (Pervasives.succ (Pervasives.succ 0))
        (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ
        (Pervasives.succ 0)) (Pervasives.succ (Pervasives.succ
        0)) (Bit (Pervasives.succ 0)) (Pervasives.succ
        (Pervasives.succ 0)) (Pervasives.succ 0))))))))))
...
let memDirCCon =
  ConcatMod
    ((modFromMeta
       (memDir0 (Pervasives.succ (Pervasives.succ 0))
         (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ
         (Pervasives.succ 0)) (Pervasives.succ (Pervasives.succ
         0)) (Bit (Pervasives.succ 0)) (Pervasives.succ 0))),
    (ConcatMod
    ((modFromMeta
       (mline (Pervasives.succ (Pervasives.succ 0))
         (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ
         (Pervasives.succ 0)) (Pervasives.succ (Pervasives.succ
         0)))),
    (modFromMeta
      (mdir (Pervasives.succ (Pervasives.succ 0))
        (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ
        0))))))
...
let childParentCCon =
  ConcatMod
    ((modFromMeta
       (childParent0 (Pervasives.succ (Pervasives.succ 0))
         (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ
         (Pervasives.succ 0)) (Pervasives.succ (Pervasives.succ
         0)) (Bit (Pervasives.succ 0)) (Pervasives.succ 0))),
    (ConcatMod
    ((modFromMeta
       (fifoRqFromC (Pervasives.succ (Pervasives.succ 0))
         (Pervasives.succ (Pervasives.succ 0)) (Bit
         (Pervasives.succ 0)) (Pervasives.succ (Pervasives.succ
         0)) (Pervasives.succ 0))), (ConcatMod
    ((modFromMeta
       (fifoRsFromC (Pervasives.succ (Pervasives.succ 0))
         (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ
         (Pervasives.succ 0)) (Pervasives.succ (Pervasives.succ
         0)) (Pervasives.succ (Pervasives.succ 0))
         (Pervasives.succ 0))),
    (modFromMeta
      (fifoToC (Pervasives.succ (Pervasives.succ 0))
        (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ
        (Pervasives.succ 0)) (Pervasives.succ (Pervasives.succ
        0)) (Bit (Pervasives.succ 0)) (Pervasives.succ
        (Pervasives.succ 0)) (Pervasives.succ 0))))))))
