...
let execHt opIdx addrSize0 lgDataBytes0 rfIdx dec opHt =
  ReadReg (('s'::('t'::('a'::('l'::('l'::[]))))), (SyntaxKind Bool), (fun stall -> Assert_ ((UniBool
    ...
    (indexBound_head { attrName = ('o'::('p'::('c'::('o'::('d'::('e'::[])))))); attrType = (Bit
      ...
      (data lgDataBytes0) }.attrName :: ({ attrName = ('i'::('n'::('s'::('t'::[])))); attrType =
      (data lgDataBytes0) }.attrName :: []))))) }, (Var ((SyntaxKind
    (decInstK opIdx addrSize0 lgDataBytes0 rfIdx)), inst)))), (Const ((Bit opIdx), opHt)))), (MCall
    (halt.attrName, halt.attrType, (Const (halt.attrType.arg, (getDefaultConst halt.attrType.arg))),
