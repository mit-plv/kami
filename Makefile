...
Makefile.coq.all: Makefile $(LIBVS) $(VS) $(EXVS) $(EXSVS) $(EXTVS) $(RTLVS) $(TIMINGVS)
	$(COQBIN)coq_makefile $(ARGS) $(LIBVS) $(VS) $(EXVS) $(EXSVS) $(EXTVS) $(RTLVS) $(TIMINGVS) -o Makefile.coq.all
